...
func (s *DoHNameServer) QueryIP(ctx context.Context, domain string, clientIP net.IP, option dns_feature.IPOption, disableCache bool, bypassCacheIfErr bool) ([]net.IP, error) { // nolint: dupl
	fqdn := Fqdn(domain)
